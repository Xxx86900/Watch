...
#define KEY_PREV_Pin GPIO_PIN_1
#define KEY_PREV_GPIO_Port GPIOB
#define VBAT_SENSE_EN_N_Pin GPIO_PIN_12
#define VBAT_SENSE_EN_N_GPIO_Port GPIOB
#define PWR_HOLD_Pin GPIO_PIN_13
#define PWR_HOLD_GPIO_Port GPIOB
#define FLASH_LED_N_Pin GPIO_PIN_15
#define FLASH_LED_N_GPIO_Port GPIOB
